---
name: openspec-next
description: Find and propose the next unblocked change from a Feature Spec. Use when the user has decomposed a requirement and wants to work through changes in dependency order.
license: MIT
...
5. **Present the situation**
   ...
   **Handle each situation:**
   ...
   e. **No unblocked, some blocked**: Explain the deadlock — which changes are blocking others.
